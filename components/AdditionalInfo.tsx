      ...
      <div className="additional-info">
        ...
        <div className="gel-layout">
          <div className="additional-info__section gel-layout__item gel-1/2@s gel-1/3@m">
            <img className="additional-info__image" src="/svgs/sustainable-inks.svg" alt="" width="70px" />
            <p className="additional-info__text">We use water-based inks, which are comprised of naturally occurring materials.</p>
          </div>
          <div className="additional-info__section gel-layout__item gel-1/2@s gel-1/3@m">
            <img className="additional-info__image" src="/svgs/sustainable-card.svg" alt="" width="70px" />
          ...
          <div className="additional-info__section gel-layout__item gel-1/3@m">
            <img className="additional-info__image" src="/svgs/sustainable-fsc.svg" alt="" width="70px" />
  ...
  if (categoryId === "wedding") {
    return (
      <div className="additional-info">
        ...
        <div className="gel-layout">
          <div className="additional-info__section gel-layout__item gel-1/2@s gel-1/3@m">
            <img className="additional-info__image" src="/svgs/sustainability-eco.svg" alt="" width="70px" />
