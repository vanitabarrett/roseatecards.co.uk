...
export default function PrivacyPolicy() {
  return (
    <div className="gel-wrap privacy-policy-page privacy-policy gel-2/3">
      <Head>
      ...
      <h2 className="privacy-policy__heading">Why we need your data</h2>
      ...
      <h2 className="privacy-policy__heading">How long we keep your data</h2>
      ...
      <h2 className="privacy-policy__heading">Children’s privacy protection</h2>
      ...
      <p className="privacy-policy__updated">Last updated: 7 November 2020</p>
    </div>
  );
}
