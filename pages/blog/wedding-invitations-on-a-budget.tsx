    ...
    <article className="gel-wrap blog-post-page" itemProp="blogPost" itemScope itemType="https://schema.org/BlogPosting">
      ...
      <div className="blog-post-page__content">
        ...
        <div itemProp="articleBody" className="blog-post-page__article-body">
          ...
          <p>Ok, so this option won’t be for everyone. But if you already have a keen eye for design, then designing and printing your own wedding invitations may be a good option. Being in control of the dimensions, paper type and envelopes of your invitations also means you are more in control of the budget, but there are a couple of things to be mindful of.</p>

          <h3>Printing yourself vs a print company</h3>
          <p>Going the DIY route means you have the option to print your invitations yourself. Be warned: most home printers aren’t suited to printing on heavy cardstock. Always check the manual to find the exact limitations of your own printer. Don’t be disheartened - you can still achieve good quality invitations and if we’re being realistic we know that most will get thrown in the recycling anyway! But if you’re looking for something luxurious, you’re very unlikely to be able to achieve those dream 400gsm textured invitations on your standard home printer.</p>
          ...
          <p>One step away from designing your own invites are downloadable designs, where you purchase a wedding invitation design but are responsible for the printing yourself. These normally come in two forms:</p>

          <ul>
            <li>templates which are personalised for you and ready to print</li>
          ...
          <ul>
            ...
            <li>ribbon</li>
            <li>belly bands</li>
            <li>pearlescent or textured cardstock</li>
          </ul>
