  ...
  return (
    <div className="gel-wrap free-download-page">
      ...
      <title>{download.title} - Roseate Cards</title>
        <meta name="description" content={`${download.title} free wedding download card, ready to print. Design by Roseate Cards.`} />

        <meta property="og:title" key="ogtitle" content={`${download.title} | Roseate Cards`} />
        <meta property="og:description" key="ogdescription" content={`${download.title} free wedding download card, ready to print. Design by Roseate Cards.`} />

        <meta property="twitter:title" key="twittertitle" content={`${download.title} | Roseate Cards`} />
        <meta property="twitter:description" key="twitterdescription" content={`${download.title} free wedding download card, ready to print. Design by Roseate Cards.`} />
      </Head>
